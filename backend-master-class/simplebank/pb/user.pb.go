...
type User struct {
	...
	Username          string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // this is field number normally use sequence number https://protobuf.dev/programming-guides/proto3/#assigning
	FullName          string                 `protobuf:"bytes,2,opt,name=full_name,json=fullName,proto3" json:"full_name,omitempty"`
	Email             string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	PasswordCreatedAt *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=password_created_at,json=passwordCreatedAt,proto3" json:"password_created_at,omitempty"` // Protobuf does not have build in date type so we use Timestamp from Google package
...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x52, 0x11, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x43, 0x72, 0x65, 0x61,
	...
	0x75, 0x78, 0x7a, 0x65, 0x72, 0x6f, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x62, 0x61, 0x6e,
...
var file_user_proto_depIdxs = []int32{
	1, // 0: pb.User.password_created_at:type_name -> google.protobuf.Timestamp
